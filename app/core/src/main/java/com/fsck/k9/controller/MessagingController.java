...
public class MessagingController {
    ...
    public void sendMessage(final Account account,
        ...
        try {
            ...
            localMessage.initializeOutboxState();
            localFolder.close();
    ...
    protected void sendPendingMessagesSynchronous(final Account account) {
        ...
        try {
            ...
            for (LocalMessage message : localMessages) {
                ...
                try {
                    message.fetchOutboxState();

                    if (message.getSendState() != SendState.READY) {
                    ...
                    Timber.i("Send count for message %s is %d", message.getUid(), message.getNumberOfSendAttempts());
                    ...
                    try {
                        ...
                        message.removeOutboxState();
                    } catch (AuthenticationFailedException e) {
                        message.decrementSendAttempts();
                        lastFailure = e;
                        ...
                        if (wasPermanentFailure) {
                            ...
                            message.setSendAttemptError(errorMessage);
                        } else if (message.getNumberOfSendAttempts() >= MAX_SEND_ATTEMPTS) {
                            message.setSendAttemptsExceeded();
                        }
